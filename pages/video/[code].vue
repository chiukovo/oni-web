  ...
  <div class="wrap">
    ...
    <div class="container">
            ...
            <div class="videoDetail__top">
              ...
              <div class="preview" :class="useVIP ? '' : 'previewLock'">
                <div class="lock" v-if="!useVIP">
                  ...
                  <vue3VideoPlay
                    v-bind="options"
                    poster="https://imagedelivery.net/wZHPgs2OG1Jdmm2gsKzHiA/a1c31898-e73c-48ab-2b64-5af7d07dbd00/public"
                  />
              </div>
            </div>
            <div class="detailTab">
      ...
      <main class="main" @scroll="onBodyScroll">
        <Transition appear>
          <div class="content" v-if="!videoDetailtab">
            <section class="sectionVideoDetail">
              <div class="videoDetail">
                <div class="item">
                  <div class="info">
