<template>
  <div class="wrap">
    ...
    <Transition name="fadeInRight" appear>
      <div class="dialog full pageVideoDetail" v-if="pageVideoDetail === true">
                  ...
                  <div class="videoDetail__top">
                    <div class="detailHeader">
                      <div class="detailback">
                        <a href="/_template/demo" class="btn btn__back" @click="pageVideoDetail = false">
